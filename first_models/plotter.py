...
plt.semilogx(grid_sizes, hydrostatic_a100["MeanTime"])
plt.semilogx(grid_sizes, second(grid_sizes))
plt.semilogx(grid_sizes, third(grid_sizes))
plt.semilogx(grid_sizes, fourth(grid_sizes))
plt.semilogx(grid_sizes, fifth(grid_sizes))
...
plt.semilogx(grid_sizes, non_hydrostatic_a100["MeanTime"])
plt.semilogx(grid_sizes, second(grid_sizes))
#plt.semilogx(grid_sizes, third(grid_sizes))
#plt.semilogx(grid_sizes, fourth(grid_sizes))
#plt.semilogx(grid_sizes, fifth(grid_sizes))
...
#plt.semilogx(grid_sizes, hydrostatic_p100["MeanTime"])
#plt.semilogx(grid_sizes, hydrostatic_a100["MeanTime"])
#plt.semilogx(grid_sizes, hydrostatic["MeanTime"])
...
#plt.clf()
#
#plt.semilogx(grid_sizes, non_hydrostatic_p100["MeanTime"])
#plt.semilogx(grid_sizes, non_hydrostatic_a100["MeanTime"])
#plt.semilogx(grid_sizes, non_hydrostatic["MeanTime"])
...
#plt.clf()
#
#plt.semilogx(grid_sizes, shallow_water_p100["MeanTime"])
#plt.semilogx(grid_sizes, shallow_water_a100["MeanTime"])
#plt.semilogx(grid_sizes, shallow_water["MeanTime"])
#plt.title("Hydrostatic Model on Three Systems")
#plt.xlabel("Grid Size")
#plt.ylabel("Mean Time")
#plt.legend(["P100","A100","CPU"])
